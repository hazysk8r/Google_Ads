...
#### 개념
고품질 광고를 확보하기 위해, 광고는 **특정 광고 위치에 표시되기 위한 최소 품질 thresholds**를 충족해야 함
...
#### 개념
광고가 표시될 때 **클릭될 빈도에 대한 예측**이며, 광고 위치를 고려하여 계산됨
...
#### 사용자의 기대
사용자는 **찾고 있는 것을 찾는 데 도움이 되는 광고 landing page**를 원함

#### 관련성의 중요성
**높은 관련성의 landing page**는 더 높은 점수를 얻음
...
#### 개념
광고 관련성은 **사용자가 검색하는 내용과 광고가 얼마나 잘 일치하는지**를 측정
